...
namespace BLL 
{
	public partial class ProductCategorys
    {
        ...
        /// 数据库操作对象
        /// </summary>
        private DAL.ProductCategorys _dao = new DAL.ProductCategorys();

        #region 向数据库中添加一条记录 +int Insert(Model.ProductCategorys model)
        /// <summary>
        /// 向数据库中添加一条记录
        /// </summary>
        ...
        #region 根据主键ID更新一条记录 +int Update(Model.ProductCategorys model)
        /// <summary>
        /// 根据主键ID更新一条记录
        /// </summary>
